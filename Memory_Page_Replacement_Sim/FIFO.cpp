...
bool FIFO::runFIFO(int userPageSize, int userPhysicalMemorySize, int limit){
...
int FIFO::searchPageTable(int frame){
...
int FIFO::chooseVictim(){
  int returnFront = front;
  
  front = (front+1)%amountOfFrames;
