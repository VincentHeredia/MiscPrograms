...
//File: Random implementation file
//=======================================================================
...
bool RandomAlg::runRandom(int userPageSize, int userPhysicalMemorySize, int limit){
...
int RandomAlg::searchPageTable(int frame){
...
int RandomAlg::searchForInvalidBit(){
...
int RandomAlg::chooseVictim(){
  int randomSelection;
  
  randomSelection = rand()%amountOfFrames;
...
//Parameters: None
//Returns: Nothing
void RandomAlg::outputPageTable(){
  for(int i = 0; i < amountOfFrames; i++){
