...
//Compiler: g++
//File Type: binstree.h  binary tree header file
//===================================================
...
class BST
{
 ...
 protected: // utility functions follow - these are not for the clients to use
  ...
  //balances the tree starting from the bottom
  void balanceTree(Vertex*, Vertex*);
  
  //Gives back the balance factor of a node
  int balanceFactor(Vertex*);
  
  //gives back the height of a node
  void Height(Vertex*, int, int&);
